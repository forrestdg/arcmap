...
FOR %%f in (%FILES%) do (
    ...
    FOR %%a in (%ALPHAS%) DO (
	    ...
	    move ..\Data\Randstad\jobs.csv ..\data\Randstad\results\jobs_scenario2__%%t_%%a_%%f
        move ..\Data\Randstad\access.csv ..\data\Randstad\results\access_scenario2__%%t_%%a_%%f
	)
    )
