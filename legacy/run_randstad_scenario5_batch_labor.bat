...
FOR %%f in (%FILES%) do (
    ...
    FOR %%a in (%ALPHAS%) DO (
	    ...
	    move ..\Data\Randstad\jobs.csv ..\data\Randstad\results\jobs_scenario5__%%t_%%a_%%f
        move ..\Data\Randstad\access.csv ..\data\Randstad\results\access_scenario5__%%t_%%a_%%f
	)
    )
